...
export default function About() {
  ...
  return (
    <section id="tentang" className="bg-black py-20 relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="grid grid-cols-2 gap-4">
            {valueCards.map((card, index) => (
              ...
              >
                ...
                <div className="bg-[#212121] rounded-r-xl py-5 pl-6 pr-4 mt-8 mr-3">
                ...
                <div className="p-4 flex gap-3 items-start mt-2">
                  {/* Icon in black square */}
                  <div className="bg-black rounded-lg w-[90px] h-[88px] flex items-center justify-center flex-shrink-0">
                    <card.icon className="w-10 h-10 text-white" />
                  </div>
                  
                  {/* Description */}
                  <p className="text-white text-[11px] leading-[13px] font-semibold text-justify pt-1">
                    {card.description}
                  </p>
                </div>
              </motion.div>
          ...
          >
            {/* Main Title */}
            <h2 className="text-[48px] md:text-[56px] font-bold leading-[1.1]">
            ...
            <div className="space-y-4 text-white text-[18px] leading-[1.4] text-justify">
              <p>
            ...
            <div className="flex gap-4 mt-8">
              {/* Vertical bar */}
              <div className="w-[7px] bg-[#898989] rounded-full flex-shrink-0" />
              
              <div className="space-y-2">
                <p className="text-white text-[28px] leading-[1.2] font-bold text-right">
                  "Website itu bukan tujuan akhir, tapi alat biar operasional jadi lebih rapi dan jelas."
                </p>
                <p className="text-white text-[18px] font-bold text-right">
