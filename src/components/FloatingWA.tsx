      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="bg-[#1a1a1a] border border-[#2e2e2e] text-white rounded-xl px-4 py-3 shadow-2xl max-w-[220px] text-right"
          >
            <p className="text-sm font-bold leading-tight">Konsultasi Gratis 30 Menit</p>
            <p className="text-[#888] text-xs mt-0.5 leading-snug">Tanpa komitmen, tanpa dipaksa beli.</p>
          </motion.div>
        )}
      </AnimatePresence>
